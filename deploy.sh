...
# main config
PLUGINSLUG='ufhealth-require-image-alt-tags' # returns basename of current directory
CURRENTDIR=`pwd`
MAINFILE="ufhealth-require-image-alt-tags.php" # this should be the name of your main php file in the wordpress plugin
SVNUSER="ufhealth" # your svn username (case sensitive)
